...
function Table7() {
    ...
    var get_SolicitudesFinalizadasPorIdPersonaA = async (idasignado) => {
        try {
            const users = await axios.get(`${url}/get_SolicitudesFinalizadasPorIdPersonaAsignada/${idasignado}`);
    ...
    useEffect(() => {
        get_SolicitudesFinalizadasPorIdPersonaA(idusuario);
    }, []);
